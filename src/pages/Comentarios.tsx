...
const ComentariosPage: React.FC = () => {
  ...
  const images = [
    '/assets/images/users/users1.png',
    '/assets/images/users/users2.png',
    '/assets/images/users/users3.png',
    '/assets/images/users/users4.png',
    '/assets/images/users/users5.png',
    '/assets/images/users/users6.png',
    '/assets/images/users/users7.png',
    '/assets/images/users/users8.png',
    '/assets/images/users/users9.png',
    '/assets/images/users/users10.png',
    '/assets/images/users/users11.png',
    '/assets/images/users/users12.png',
    '/assets/images/users/users13.png',
    '/assets/images/users/users14.png',
    '/assets/images/users/users15.png',
    '/assets/images/users/users16.png',
    '/assets/images/users/users17.png',
    '/assets/images/users/users18.png',
    '/assets/images/users/users19.png',
    '/assets/images/users/users20.png',
  ];
